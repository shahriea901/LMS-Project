...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1699034388ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slibrary&table=returnbook">`slibrary`.`returnbook`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slibrary&table=lendbook">`slibrary`.`lendbook`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slibrary&table=member">`slibrary`.`member`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slibrary&table=publisher">`slibrary`.`publisher`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slibrary&table=book">`slibrary`.`book`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slibrary&table=category">`slibrary`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=slibrary&table=author">`slibrary`.`author`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=library-system&table=category">`library-system`.`category`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=library-system&table=author">`library-system`.`author`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=library-system&table=book">`library-system`.`book`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="61506f6d77306359433f61765d603a3d">
